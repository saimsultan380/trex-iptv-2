  ...
  return (
    <>
      <SectionBlock title="One Connection" accent="Explained">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
          {connectionExamples.map((item, i) => {
            ...
            return (
              <div key={i} className="flex items-start gap-3 px-4 py-3 glass-card-hover h-full">
      ...
      <SectionBlock title="Player-App Charges Are" accent="Separate">
        <div className="glass-card p-6 sm:p-8 space-y-3">
          ...
          <p className="text-zinc-600 text-[13px] sm:text-[15px] leading-relaxed font-medium flex items-start gap-2">
            <AppWindow className="h-5 w-5 text-[#ff3503] shrink-0 mt-0.5" />
      ...
      <SectionBlock title="Activation and" accent="Delivery">
        <div className="glass-card p-6 sm:p-8 space-y-3">
          <p className="text-zinc-600 text-[13px] sm:text-[15px] leading-relaxed font-medium flex items-start gap-2">
            <Mail className="h-5 w-5 text-[#ff3503] shrink-0 mt-0.5" />
      ...
      <SectionBlock title="Renewal and" accent="Expiration">
        <div className="glass-card p-6 sm:p-8 space-y-3">
          <p className="text-zinc-600 text-[13px] sm:text-[15px] leading-relaxed font-medium flex items-start gap-2">
            <RefreshCw className="h-5 w-5 text-[#ff3503] shrink-0 mt-0.5" />
      ...
      <SectionBlock title="Try Before Choosing Longer" accent="Access">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
          {trialChecks.map((item) => (
            <div key={item} className="flex items-center gap-3 px-4 py-3 glass-card-hover h-full">
        ...
        <motion.a
          ...
          className="inline-flex h-12 items-center justify-center rounded-full bg-[#ff3503] btn-brand-animated px-8 text-[13px] sm:text-sm font-bold text-white shadow-sm hover:bg-[#e62e03] transition-colors"
        >
