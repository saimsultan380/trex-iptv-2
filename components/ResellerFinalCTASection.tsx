      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="text-zinc-600 text-[13px] sm:text-[16px] leading-relaxed max-w-2xl mb-6 sm:mb-8">
            Join hundreds of active resellers already making money with the Trex IPTV reseller panel. Pick a plan, get your Trex IPTV reseller panel activated in minutes, and start selling to your first client today.
          </p>
