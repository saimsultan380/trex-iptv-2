    ...
    <section className="mx-auto max-w-7xl w-full px-6 py-12 sm:px-8 sm:py-20 lg:py-28 bg-white">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="text-[#ff3503] text-[11px] sm:text-sm font-bold tracking-wide mb-5">
          ...
          <div className="flex flex-row flex-wrap items-center justify-center gap-3">
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex h-11 sm:h-12 items-center justify-center gap-2 rounded-full bg-[#ff3503] btn-brand-animated px-5 sm:px-7 text-[12px] sm:text-sm font-bold text-white shadow-sm hover:bg-[#e62e03] transition-colors whitespace-nowrap"
            >
            ...
            <motion.a
              ...
              className="inline-flex h-11 sm:h-12 items-center justify-center gap-2 rounded-[4px] border border-zinc-300 bg-white px-5 sm:px-7 text-[12px] sm:text-sm font-bold text-zinc-900 hover:bg-zinc-50 transition-colors whitespace-nowrap"
            >
              <ShoppingCart className="h-4 w-4 text-[#ff3503]" />
