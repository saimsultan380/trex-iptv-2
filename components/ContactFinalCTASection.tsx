      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-[22px] sm:text-4xl lg:text-[44px] font-extrabold tracking-tight leading-tight text-zinc-900 mb-4 sm:mb-5 max-w-3xl">
            ...
            <span className="text-[#ff6b35]">Trex IPTV</span> Free Trial Today
          </h2>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 sm:gap-3 w-full">
            <motion.a
              ...
              className="inline-flex h-11 sm:h-12 w-full sm:w-auto items-center justify-center gap-2 rounded-[4px] bg-[#ff6b35] px-4 sm:px-8 text-[12px] sm:text-sm font-bold text-white shadow-sm hover:bg-[#ff5722] transition-colors"
            >
