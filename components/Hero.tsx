...
export default function Hero() {
  return (
    <section id="hero" className="w-full bg-[#ffffff]">
      <div className="mx-auto max-w-7xl w-full px-6 pt-28 pb-10 sm:px-8 sm:pt-40 sm:pb-12 lg:pt-48 lg:pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-6 items-center">
        <div className="lg:col-span-6 flex flex-col text-left">
          ...
          >
            <span className="text-[#ff6b35]">Trex IPTV</span> for Live TV, Movies and Series
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-5 sm:mt-8 text-[11px] sm:text-[13px] font-semibold text-zinc-500"
          >
            {trustPoints.join(" • ")}
          </motion.p>
        </div>
