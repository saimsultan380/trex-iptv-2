...
import ReviewsInfoSections from "@/components/reviews/ReviewsInfoSections";
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-6 flex flex-col text-left order-1">
              ...
              >
                <span className="text-[#ff6b35]">Trex IPTV</span> Reviews from Verified Customers
              </motion.h1>
              ...
              >
                Customer feedback should help visitors make an informed decision. It should not be a
                collection of anonymous marketing promises.
              </motion.p>
              ...
              >
                This page is reserved for reviews connected to a real purchase, approved trial or
                support experience.
              </motion.p>
