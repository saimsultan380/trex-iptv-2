...
import SubscriptionDetailsSections from "@/components/SubscriptionDetailsSections";
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-6 flex flex-col text-left order-1">
              ...
              >
                Choose the access period that matches your needs.
              </motion.p>
              ...
              >
                Every standard option includes the same main service features. The difference is the length of access and the average monthly cost.
              </motion.p>
