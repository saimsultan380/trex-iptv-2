...
import {
  ...
  WhatWeControlSection,
  WhatCanChangeSection,
  ResponsibleUseSection,
  BeforePurchaseSection,
} from "@/components/about-us/AboutUsInfoSections";
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-6 flex flex-col text-left order-1">
              ...
              >
                About <span className="text-[#ff3503]">Trex IPTV</span>
              </motion.h1>
              ...
              >
                Trex IPTV helps viewers access live television and on-demand entertainment through
              ...
              >
                Our aim is to explain the service clearly, help customers prepare the correct setup
