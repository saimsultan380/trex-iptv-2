...
import InstallationPlayerSettings from "@/components/InstallationPlayerSettings";
import TroubleshootingSection, {
  InstallationSupportSection,
} from "@/components/TroubleshootingSection";
...
export default function InstallationGuideClient() {
  return (
    <div className="min-h-screen bg-white text-zinc-950 font-sans antialiased flex flex-col">
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-6 flex flex-col text-left order-1">
              ...
              >
                <span className="text-[#ff6b35]">Trex IPTV</span> Installation Guide
              </motion.h1>
              ...
              >
                Use this guide after receiving your login details.
              </motion.p>
              ...
              >
                Menus may look slightly different depending on your device and player version, but the account information remains similar.
              </motion.p>
      ...
      <ScrollReveal>
        <div id="device-guides">
          <InstallationTabs />
        </div>
      </ScrollReveal>
      <ScrollReveal>
        <InstallationPlayerSettings />
      </ScrollReveal>
      <ScrollReveal>
